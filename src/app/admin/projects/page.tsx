      ...
      <div>
        <Breadcrumb
          items={[
            ...
            { label: "Strategic Projects Management" },
          ]}
        />
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          ...
          <button
            ...
            disabled={exporting}
            className="inline-flex items-center space-x-2 px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-2xl shadow-sm transition-all hover:scale-105 disabled:opacity-50"
          >
        ...
        <div className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-xs mb-8">
          ...
          <p className="text-xs text-slate-500 mb-4">
            Upload the official Provincial Annual Work Plan Excel file to bulk-import activities and quarterly schedules.
          </p>
          ...
          <form onSubmit={handleImport} className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
            <div className="md:col-span-9">
              <input
                ...
                accept=".xlsx,.xls"
                required
                className="w-full text-xs text-slate-500 file:mr-4 file:py-2.5 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 border border-slate-200 rounded-2xl p-2 bg-slate-50/50"
              />
            </div>
                ...
                {filteredProjects.length === 0 ? (
                  <tr>
                    <td colSpan={12} className="py-12 text-center text-slate-400">
                      ...
                      <p className="text-[11px] mt-0.5">Upload an Excel file above to populate records.</p>
                    </td>
                  </tr>
                ) : (
          ...
          {totalPages > 1 && (
            <div className="p-4 border-t border-slate-100 flex justify-between items-center">
              <button
                ...
                disabled={page === 1}
                className="px-3.5 py-1.5 rounded-xl border border-slate-200 text-xs font-bold disabled:opacity-40 hover:bg-slate-50"
              >
                Previous
              </button>
